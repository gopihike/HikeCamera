...
public class OESTexture {
    ...
    public void init(){
        ...
        mTextureHandle[0] = mTextureHandles[0];

        GLES20.glBindTexture(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, mTextureHandles[0]);
        //GLES20.glTexImage2D(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, 0, GLES20.GL_RGBA, surfaceWidth, surfaceHeight, 0,GLES20.GL_RGBA, GL10.GL_UNSIGNED_BYTE, null);
